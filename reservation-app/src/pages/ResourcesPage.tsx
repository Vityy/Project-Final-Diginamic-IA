...
export default function ResourcesPage() {
  ...
  const [draft, setDraft] = useState<Omit<Resource, 'id'>>({
    type: '',
    description: '',
    available: true,
  })
  ...
  async function create() {
    try {
      if (!token) throw new Error('Utilisateur non authentifié')
      await api.createResource(token, draft)
      ...
      <div className="card" style={{ marginBottom: '1rem' }}>
        ...
        >
          ...
          <Select
            ...
            onChange={(e) =>
              setDraft({ ...draft, available: e.target.value === 'true' })
            }
          >
      ...
      <Table>
        <thead>
          <tr>
            ...
            <th style={{ textAlign: 'left', padding: '.5rem' }}>
              Disponibilité
            </th>
